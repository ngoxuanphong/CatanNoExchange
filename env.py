...
def getValidActions(p_state: np.ndarray):
    ...
    if phase == 6:  # Chọn các mô đun giữa turn
        ...
        if (p_state[200:205] > 0).any() and p_state[186] == 0:
...
def one_game(list_player, per_file):
    ...
    while env[230] < 1000:
        ...
        all_source = env[48:53] + env[58:58+5] + env[100:100+5] + env[142:142+5]+ env[184:184+5] + env[254: 259]+ env[259: 264]+ env[264: 269]+ env[269: 274]
        # if len(np.where(actions == 1)[0]) == 0:
        s_ = 58 + 42*p_idx
            # raise 1
